...
import com.example.test.application.excepcion.*;
        ...
        return ErrorResponse.builder()
                ...
                .errorFields(
                        Collections.singletonList(
                                ErrorResponse.ErrorFieldResponse.builder().field(ex.getName()).message(ex.getMessage()).build()
                        )
                )
                .build();
    }
        ...
        return ErrorResponse.builder()
                ...
                .errorFields(
                        ex.getBindingResult().getFieldErrors()
                                .stream()
                                .map(fieldError ->
                                        ErrorResponse.ErrorFieldResponse.builder()
